      ...
      <div className="min-h-screen">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  >
                    ...
                    <span>{t('home.hero.downloadFree')}</span>
                  </motion.button>
                ...
                <div className="flex items-center space-x-6 text-sm text-neutral-600">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{t('home.hero.freeToStart')}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-success-500" />
                    <span>{t('home.hero.worksOffline')}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-success-500" />
                    <span>{t('home.hero.securePrivate')}</span>
                  </div>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl lg:text-5xl font-bold text-neutral-900 mb-6">
                {t('home.problem.title').split(' ').slice(0, 2).join(' ')} <span className="text-error-600">{t('home.problem.title').split(' ').slice(2).join(' ')}</span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-error-900 mb-4">{t('home.problem.teacherBurnout.title')}</h3>
                <p className="text-error-700 leading-relaxed">
                  {t('home.problem.teacherBurnout.description')}
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-warning-900 mb-4">{t('home.problem.dataBlindness.title')}</h3>
                <p className="text-warning-700 leading-relaxed">
                  {t('home.problem.dataBlindness.description')}
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-primary-900 mb-4">{t('home.problem.digitalDivide.title')}</h3>
                <p className="text-primary-700 leading-relaxed">
                  {t('home.problem.digitalDivide.description')}
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-neutral-50 to-primary-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl lg:text-5xl font-bold text-neutral-900 mb-6">
                {t('features.title').split(',')[0]}, <span className="text-primary-600">{t('features.title').split(',')[1]}</span>
              </h2>
              <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                {t('features.subtitle')}
              </p>
